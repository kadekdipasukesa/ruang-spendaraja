export const DUMMY_TUGAS = [
  ...
  {
    id: "tugas-inf-03",
    kode_tugas: "TUGAS-03-SCRATCH-ANIMASI",
    urutan: 3,
    title: "Proyek Animasi Dialog Percakapan Scratch",
    judul: "Proyek Animasi Dialog Percakapan Scratch",
    subject: "Informatika",
    category: "Pemrograman Visual",
    kategori: "Pemrograman Visual",
    difficulty: "Menengah",
    tipe_tugas: "submit",
    custom_route: null,
    points: 100,
    ...
    description: "Buatlah proyek animasi interaktif di Scratch yang memuat dialog antara dua karakter (sprite) bertema 'Etika di Ruang Digital'. Setiap karakter berbicara bergantian menggunakan broadcast pesan.",
    deskripsi: "Buatlah proyek animasi interaktif di Scratch yang memuat dialog antara dua karakter (sprite) bertema 'Etika di Ruang Digital'. Setiap karakter berbicara bergantian menggunakan broadcast pesan.",
    petunjuk: [
      "Buka platform Scratch (scratch.mit.edu atau Scratch Desktop).",
      "Pilih 2 sprite karakter berbeda dan 2 backdrop relevan.",
      "Gunakan blok 'say ... for ... seconds' dan blok 'broadcast' untuk jeda percakapan.",
      "Simpan dan salin tautan link proyek Scratch Anda, lalu kirim melalui form di bawah."
    ],
    instructions: [
      "Buka platform Scratch (scratch.mit.edu atau Scratch Desktop).",
      "Pilih 2 sprite karakter berbeda dan 2 backdrop relevan.",
    ...
    attachments: [
      { name: "Panduan_Broadcast_Scratch.pdf", type: "pdf", size: "1.2 MB", url: "#" }
    ],
    submission: null
  },
  {
