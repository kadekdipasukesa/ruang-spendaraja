...
export default function TimelineTugas({
  ...
  const getTaskActionButton = (task) => {
    ...
    // Never started / Belum ada di database -> Mulai dari awal
    ...
    <div className="space-y-6">
      ...
      <div className="relative pl-6 sm:pl-10 space-y-8 before:absolute before:left-3 sm:before:left-5 before:top-4 before:bottom-4 before:w-0.5 before:bg-slate-200">
        {tasks.map((task, idx) => {
          ...
          const isInProgress = isPartial || task.status === 'sedang';
            ...
            >
              ...
              >
                ...
                <div className="mt-5 pt-4 border-t border-slate-100 flex items-center justify-between gap-4 flex-wrap">
                  ...
                  {/* Unified Action Button: Direct navigation for quick continuation or detail modal */}
                  {(() => {
                    ...
                    return (
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="px-3 py-2 text-xs font-semibold text-slate-600 hover:text-indigo-600 hover:bg-slate-100 rounded-xl transition"
                          title="Lihat Petunjuk & Rincian Tugas"
                        >
                          Petunjuk
                        </button>
                        <button
